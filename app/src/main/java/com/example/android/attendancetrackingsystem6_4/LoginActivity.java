...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void parseResponse(String response){
        ...
        if(!obj.has("group")){
            //popup register sonra login activity
            Intent homepage = new Intent(LoginActivity.this, LoginActivity.class);
...
// Instantiate the RequestQueue.
                ...
                String url ="http://ase2017-group6-4.appspot.com/rest/authentication/login";
...
// Request a string response from the provided URL.
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public byte[] getBody() throws AuthFailureError {
                        ...
                        params2.put("email", mEmail);
                        params2.put("password", mPassword);
